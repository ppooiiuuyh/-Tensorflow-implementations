            ...
            # 매epoch 마다 test 데이터셋에 대한 정확도와 loss를 출력.
                ...
                for i in range(int(len(self.testset) / self.batchSize_test)):
                    ...
                    for o in range(10):
                        ...
                        print( "정답: ", np.argmax(test_batch_y[o]),"출력: ",output_scalar)

                print("테스트 데이터 정확도:", np.mean(test_accuracy_list),"손실 함수(loss):",
                      np.mean(loss_list))
                print()
