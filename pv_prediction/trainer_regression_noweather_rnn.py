...
class Trainer:
    ...
    # ==========================================================
        ...
        with tf.name_scope("trainer") as scope:
            loss = tf.reduce_mean(tf.losses.mean_squared_error(labels= self.Y,predictions=self.model.logits))#+lossL2
    ...
    # ==================================================
        ...
        # ==============================================
            ...
            writer_acc_loss = tf.summary.FileWriter("./board_rrnw/acc_loss", sess.graph)
            ...
            writer_pred = tf.summary.FileWriter("./board_rrnw/pred", sess.graph)
            writer_pred_label = tf.summary.FileWriter("./board_rrnw/pred_label", sess.graph)
        ...
        #===============================================
            ...
            # .........................
                ...
                for i in range(int(len(self.trainset) / self.batchSize)):
                    ...
                    # == logging
                    loss_print = loss.eval(feed_dict={self.model.X: batch_x, self.Y: batch_y, })
            ...
            # 매epoch 마다 test 데이터셋에 대한 정확도와 loss를 출력.
                ...
                if (e % histloginterval == 0):
                    writer_pred = tf.summary.FileWriter("./board_rrnw/pred" + str(e), sess.graph)
                    writer_pred_label = tf.summary.FileWriter("./board_rrnw/pred_label" + str(e), sess.graph)
