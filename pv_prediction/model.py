...
class Model:
    def __init__(self,input_dim,output_dim,modelname = ""):
    ...
    def apply_logit(self):
        num_unit = 300
        H = self.linear(self.X,self.input_dim,num_unit,'L1')
        ...
        self.output = self.linear(H,300,self.output_dim,"output",active_f=None)
        return self.output
