...
from model_cnn_regression2 import Model
...
class Trainer:
    ...
    # ==================================================
        ...
        # ==============================================
            ...
            writer_acc_loss = tf.summary.FileWriter("./board_crnw/acc_loss", sess.graph)
            ...
            writer_pred = tf.summary.FileWriter("./board_crnw/pred", sess.graph)
            writer_pred_label = tf.summary.FileWriter("./board_crnw/pred_label", sess.graph)
        ...
        #===============================================
            ...
            # 매epoch 마다 test 데이터셋에 대한 정확도와 loss를 출력.
                ...
                if(e%histloginterval == 0):
                    writer_pred = tf.summary.FileWriter("./board_crnw/pred"+str(e), sess.graph)
                    writer_pred_label = tf.summary.FileWriter("./board_crnw/pred_label"+str(e), sess.graph)
