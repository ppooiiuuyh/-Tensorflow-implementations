...
#=========================================================
    ...
    loss_hist_summary = tf.summary.scalar('loss_hist',loss)

    merged = tf.summary.merge_all()
    accuracy_hist_merged = tf.summary.merge([ accuracy_hist_summary ])
...
#==========================================================
    ...
    #----------------------------------
        ...
        writer_train = tf.summary.FileWriter("./board/train",sess.graph)
        writer_test = tf.summary.FileWriter("./board/test", sess.graph)
